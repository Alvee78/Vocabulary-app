...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: 'transparent', // Use transparent to allow ScreenWrapper background to show
    paddingTop: StatusBar.currentHeight, // Adjust for notch/status bar
  },
  loadingContainer: {
    flex: 1,
  ...
  cancelButton: { // New style for the cancel button in modal
  ...
  shuffleButton: { // Style for the new shuffle button
